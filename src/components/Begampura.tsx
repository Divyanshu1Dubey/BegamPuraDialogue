...
export function Begampura() {
  return (
    <section id="begampura" className="relative py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-bg via-violet-deep/10 to-bg pointer-events-none" />
      ...
      <div className="relative mx-auto max-w-7xl px-4 lg:px-8">
        ...
        >
          ...
          <p className="mt-8 text-base md:text-lg text-ink-soft leading-relaxed">
            <LanguageAware
              en="Five hundred years before modern constitutions, five centuries before the Universal Declaration of Human Rights — one saint of Varanasi wrote the world's first charter of a truly egalitarian society. He called it Begampura."
        ...
        >
          <div className="relative rounded-[2rem] p-8 md:p-12 bg-gradient-to-br from-saffron/8 via-royal/5 to-saffron/5 border border-saffron/25 card-glass card-saffron-glow">
        ...
        >
          <div className="text-center mb-14">
            ...
            <p className="mt-4 text-ink-soft max-w-3xl mx-auto">
              <LanguageAware
                en="How the principles of Begampura align with the ideals of an inclusive, sovereign, and service-oriented governance model — where the state bows before the citizen, not the other way around."
            ...
            {[
              {
                ...
                desc: "Modern governance treats the Parliament as the temple of democracy — yet truly democratic policy must be crafted from the ground up. The governance paradigm of Begampura demands citizen-centric legislation: that the poor have the loudest voice in policy rooms.",
              ...
              },
              {
                ...
                desc: "The hallmarks of inclusive welfare — skilling the underprivileged (Kirat), building healthcare for all, ensuring food security. When governance aligns with Begampura, the state becomes the great equaliser.",
              ...
              },
              {
                ...
                desc: "From the chowkidar to the Chief — every citizen is a sovereign. A governance model rooted in Begampura insists on universal minimum wage, workers' rights, and the celebration of all labour as divine.",
              ...
              },
              {
                ...
                desc: "Over the past decade and a half, India has witnessed one of the most ambitious social reform programmes in modern history — Swachh Bharat, Ayushman Bharat, Ujjwala, Housing for All, Skill India — each echoing the Begampura vision in policy form.",
              ...
              },
              {
                ...
                desc: "The ultimate governance goal: a society where sorrow, fear, and exploitation have no address. This is Begampura's blueprint for a New India — and for every nation that dares to dream of something better.",
              ...
              return (
                ...
                >
                  <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-saffron/20 to-royal/20 flex items-center justify-center mb-4">
        ...
        {/* Core Begampura shabads strip */}
        <motion.div
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="rounded-3xl p-8 md:p-12 bg-gradient-to-r from-bg-soft via-surface to-bg-soft border border-border/50"
        >
